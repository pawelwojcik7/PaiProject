...
public class AppServiceService {
    ...
    public void checkBookSubscriptions(String name) throws RuntimeException {
        ...
        if (byLogin.isEmpty()) throw new RuntimeException("User does not exist");
            ...
            if (appUser.getSubscription() == null || appUser.getSubscription().equals(""))
                throw new RuntimeException("You must subscribe to the minimum default service");
        }
    ...
    public void checkFilmSubscriptions(String name) throws RuntimeException {
        ...
        if (byLogin.isEmpty()) throw new RuntimeException("User does not exist");
            ...
            AppUser appUser = byLogin.get();
            if (appUser.getSubscription() == null || appUser.getSubscription().equals("") || appUser.getSubscription().equals(ServiceName.DEFAULT.getCode()))
                throw new RuntimeException("You must subscribe to the minimum normal service");
        }
    ...
    public void checkGameSubscriptions(String name) throws RuntimeException {
        ...
        if (byLogin.isEmpty()) throw new RuntimeException("User does not exist");
            ...
            AppUser appUser = byLogin.get();
            if (appUser.getSubscription() == null || appUser.getSubscription().equals("") || appUser.getSubscription().equals(ServiceName.DEFAULT.getCode()) || appUser.getSubscription().equals(ServiceName.NORMAL.getCode()))
                throw new RuntimeException("You must subscribe to the premium service");
        }
